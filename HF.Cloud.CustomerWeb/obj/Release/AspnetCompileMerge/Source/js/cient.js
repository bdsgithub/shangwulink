...
$(document).ready(function () {
    ...
    $('.cient-left li').on('click', function () {
        ...
        if ($nu == 0) {
            ...
            $("iframe").attr('src', '/Sheet/CustomerSheetList.aspx')
        } else if ($nu == 2) {
            $("iframe").attr('src', '/Asset/CustomerAssetList.aspx')
        } else if ($nu == 3) {
            $("iframe").attr('src', '/Report/AssetRepairsCountRpt.aspx')
        } else if ($nu == 4) {
            $("iframe").attr('src', '/Inspect/RecordList.aspx')
        }
        else if ($nu == 5) {
            $("iframe").attr('src', '/Repair/RepairList.aspx')
        }
        else if ($nu == 6) {
