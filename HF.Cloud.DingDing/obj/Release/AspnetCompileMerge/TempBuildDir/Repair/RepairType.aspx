<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RepairType.aspx.cs" Inherits="HF.Cloud.DingDing.Repair.RepairType" %>
         ...
         dd.ready(function () {
             ...
             dd.biz.navigation.setMenu({
                 ...
                 onSuccess: function (data) {
                     var menuID = data.id;
                     if (menuID == "1")//如果点击了添加维系，跳转到维修添加
                     {
                         window.location.href = "AddRepair.aspx?dd_nav_bgcolor=FF5E97F6";
                     }
                 },
                 onFail: function (err) {
