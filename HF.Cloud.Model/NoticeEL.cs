   ...
   public class NoticeEL
    {
        ...
        /// 好友用户ID
        /// </summary>
        private long m_UserID_Friend;
        /// <summary>
        /// 群组ID（审核用）
        /// </summary>
        private long m_GroupID;
        /// <summary>
        /// 通知类型  0个人   1公司   2系统  3加群审核通知
        /// </summary>
        private int m_NoticeType;
        /// <summary>
        /// 状态，  0非好友    1好友      2忽略
        /// </summary>
        private int m_NoticeState;
        /// <summary>
        /// 是否查看，  0未查看    1已经查看
        /// </summary>
        ...
        /// 存储过程名称
        /// </summary>
        private readonly string proceName = "SP_Notice";
        ...
        public DataTable GetTable()
        {
            ...
            dt.Columns.Add("UserID_Friend", typeof(long));
            dt.Columns.Add("GroupID", typeof(long));
            dt.Columns.Add("NoticeType", typeof(int));
            dt.Columns.Add("NoticeState", typeof(int));
            ...
            dr["ID"] = m_ID;
            dr["UserID"] = m_UserID;
            dr["UserID_Friend"] = m_UserID_Friend;
            dr["GroupID"] = m_GroupID;
            dr["NoticeType"] = m_NoticeType;
            dr["NoticeState"] = m_NoticeState;
            dr["IsLook"] = m_IsLook;
        ...
        public void InitByRow(DataRow dr)
        {
            ...
            m_UserID_Friend = (long)dr["UserID_Friend"];
            m_GroupID = (long)dr["GroupID"];
            m_NoticeType = (int)dr["NoticeType"];
            m_NoticeState = (int)dr["NoticeState"];
        ...
        private SqlParameterCollection InitCmd(int iOperateFlag)
        {
            ...
            param = new SqlParameter("@UserID_Friend", SqlDbType.BigInt);
            param.Value = m_UserID_Friend;
            mCmd.Parameters.Add(param);
            ...
            param = new SqlParameter("@NoticeState", SqlDbType.Int);
            param.Value = m_NoticeState;
            mCmd.Parameters.Add(param);
        ...
        /// 好友用户ID
        /// </summary>
        public long UserID_Friend
        {
            get
            { return this.m_UserID_Friend; }
            set
            { this.m_UserID_Friend = value; }
        }
        /// <summary>
        /// 群组ID（加入群组审核用）
        /// </summary>
        ...
        public int NoticeState
        {
            get
            {
                return this.m_NoticeState;
            }
            set
            {
                this.m_NoticeState = value;
            }
        }
        /// <summary>
        /// 是否查看，  0未查看    1已经查看
