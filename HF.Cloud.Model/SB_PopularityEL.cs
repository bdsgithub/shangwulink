  ...
  public   class SB_PopularityEL
    {
        ...
        /// 存储过程名称
        /// </summary>
        private readonly string proceName = "SP_SB_Popularity";

        /// <summary>
        /// 构造函数
        /// </summary>
        public SB_PopularityEL()
        {
        ...
        public DataTable GetTable()
        {
            ...
            dt.Columns.Add("UserID_Look", typeof(long));
        ...
        public void InitByRow(DataRow dr)
        {
            ...
            m_UserID_Look = (long)dr["UserID_Look"];
        ...
        private SqlParameterCollection InitCmd(int iOperateFlag)
        {
            ...
            param = new SqlParameter("@UserID_Look", SqlDbType.BigInt);
            param.Value = m_UserID_Look;
            mCmd.Parameters.Add(param);
        ...
        /// 查看人用户ID
        /// </summary>
        public long UserID_Look
        {
            get
            { return this.m_UserID_Look; }
            set
            { this.m_UserID_Look = value; }
        }
        /// <summary>
        /// 时间
        /// </summary>
