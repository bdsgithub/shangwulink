   ...
   public class CompanysEL
    {
        ...
        /// 存储过程名称
        /// </summary>
        private readonly string proceName = "SP_Companys";
        ...
        /// <returns></returns>
        public DataSet GetPageList(string strTableName, int PageIndex, string strWhere, string strOrder, int orderType)
        {
        ...
        public DataTable GetTable()
        {
            ...
            dt.Columns.Add("CompanyIcon", typeof(string));
            ...
            dr["ID"] = m_ID;
            dr["CompanyName"] = m_CompanyName;
            dr["CompanyIcon"] = m_CompanyIcon;
        ...
        public void InitByRow(DataRow dr)
        {
            if (null == dr) return;
            m_ID = (long)dr["ID"];
            m_CompanyName = dr["CompanyName"].ToString();
            m_CompanyIcon = dr["CompanyIcon"].ToString();
        ...
        private SqlParameterCollection InitCmd(int iOperateFlag)
        {
            ...
            param = new SqlParameter("@CompanyName", SqlDbType.VarChar, 50);
            if (m_CompanyName == "")
                param.Value = DBNull.Value;
            else
                param.Value = m_CompanyName.Trim();
            mCmd.Parameters.Add(param);

            param = new SqlParameter("@CompanyIcon", SqlDbType.VarChar, 200);
            if (m_CompanyIcon == "")
                param.Value = DBNull.Value;
            else
                param.Value = m_CompanyIcon.Trim();
            mCmd.Parameters.Add(param);

            param = new SqlParameter("@Introduce", SqlDbType.VarChar, 2000);
            if (m_Introduce == "")
                param.Value = DBNull.Value;
            else
        ...
        {
            get
            { return this.m_CompanyIcon; }
            set
            { this.m_CompanyIcon = value; }
        }
