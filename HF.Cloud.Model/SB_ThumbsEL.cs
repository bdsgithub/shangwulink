...
namespace HF.Cloud.Model
{
     ...
     public   class SB_ThumbsEL
    {
        ...
        /// 存储过程名称
        /// </summary>
        private readonly string proceName = "SP_SB_Thumbs";
        ...
        public DataTable GetTable()
        {
            ...
            dt.Columns.Add("UserID_Thumb", typeof(long));
            ...
            dr["ID"] = m_ID;
            dr["UserID"] = m_UserID;
            dr["UserID_Thumb"] = m_UserID_Thumb;
        ...
        public void InitByRow(DataRow dr)
        {
            ...
            m_UserID_Thumb = (long)dr["UserID_Thumb"];
        ...
        private SqlParameterCollection InitCmd(int iOperateFlag)
        {
            ...
            param = new SqlParameter("@UserID_Thumb", SqlDbType.BigInt);
            param.Value = m_UserID_Thumb;
            mCmd.Parameters.Add(param);
        ...
        /// 
        /// </summary>
        public long UserID_Thumb
        {
            get
            { return this.m_UserID_Thumb; }
            set
            { this.m_UserID_Thumb = value; }
        }
        /// <summary>
        /// 
        /// </summary>
