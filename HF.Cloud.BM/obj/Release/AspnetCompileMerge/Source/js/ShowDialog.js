...
function popup(width, height, src) {
    if ($('div').is('.page')) {
        ...
        $(".close").after('<iframe src="' + src + '" id="iframepage" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" style="width: ' + width + 'px;height: ' + height + 'px;margin-top:5px;"></iframe>');
        $('.page').click(function () {
            $(this).remove();
            $('.cont').remove();
        })
