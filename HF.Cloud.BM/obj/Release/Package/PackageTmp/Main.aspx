<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Main.aspx.cs" Inherits="HF.Cloud.BM.Main" %>
        ...
        <div class="cient-top">
            ...
            <div class="cient-repairs" style="width: 250px;">
                <p class="font-color-w" id="changemain" style="cursor: pointer;">
                    <%--服务商--%>&nbsp;&nbsp;
                    <asp:DropDownList Style="width: 180px; display:none;" runat="server" ID="ddlMain" OnSelectedIndexChanged="ddlMain_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                </p>
            </div>
        </div>
