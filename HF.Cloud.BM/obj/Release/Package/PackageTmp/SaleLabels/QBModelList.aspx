<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QBModelList.aspx.cs" Inherits="HF.Cloud.BM.SaleLabels.QBModelList" %>
        ...
        <div class="manage-title" style="margin-top: 20px; height: 30px;">
            <h2>
                ...
                <p class="cut-off" style="font-size: 14px; font-weight: normal; float: right; margin-right: 80px; display: inline-block;">
                    <a href="QBModelAdd.aspx" style="display: inline-block; width: 55px; background-color: #1fb5ac; height: 30px; border-radius: 3px;color:white;text-align:center;vertical-align:middle;line-height:28px;font-size:14px;">新增</a>
                </p>
            </h2>
        </div>
