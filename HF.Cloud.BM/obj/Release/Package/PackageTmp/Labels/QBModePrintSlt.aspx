<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QBModePrintSlt.aspx.cs" Inherits="HF.Cloud.BM.Labels.QBModePrintSlt" %>
        ...
        <div>
            <div class=" work-center float-r-s margin-top-s padding-s">
                ...
                <div class="border-c padding-top-s margin-top-s overflow-h">
                    ...
                    <div class="select float-l-s float-left margin-top-s">
                        <asp:RadioButtonList ID="rblPrintSelect" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
