    ...
    public partial class QBModelList : BasePage
    {
        ...
        private void InitPage()
        {
            ...
            foreach (DataRow drModel in dtModel.Rows)
            {
                ...
                ModelHtml.Append("<a href=\"QBModePrintSlt.aspx?tid=" + drModel["ID"] + "&mainId=" + mainId + "\" ><img src=\"../image/label-p.png\" alt=\"\" /><span> 打印</span></a>");
                ModelHtml.Append("</div>");
                ModelHtml.Append("<div class=\"label-button\">");
                ModelHtml.Append("<a href=\"QBModelAdd.aspx?id=" + drModel["ID"] + "&mainId=" + mainId + "\" ><img src=\"../image/label-c.png\" alt=\"\" /><span> 编辑</span></a>");
                ModelHtml.Append("</div>");
                ModelHtml.Append("<div class=\"label-button\">");
