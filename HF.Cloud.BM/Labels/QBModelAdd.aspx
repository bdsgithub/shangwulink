<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QBModelAdd.aspx.cs" Inherits="HF.Cloud.BM.Labels.QBModelAdd" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#btnQuit").click(function () {
                document.location.href = 'QBModelList.aspx?mainId=<%= mid%>';
            });
            //上一步
...
<body class="eweic-box">
    <form id="form1" runat="server">
        ...
        <asp:HiddenField runat="server" ID="hidModel" />
         <asp:HiddenField runat="server" ID="hf_entag" />
        <asp:HiddenField runat="server" ID="hf_mid" />
    </form>
</body>
</html>
