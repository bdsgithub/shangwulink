...
{
    /// <summary>
    /// UploadYSTImage 的摘要说明
    /// </summary>
    public class UploadYSTImage : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            if (context.Request.Files.Count > 0)
            {
                ...
                //图片保存在服务器的地址   D:\WebapiPublish\UploadYSTImage
                string allName = "D:/WebapiPublish/UploadYSTImage/" + newName + fileExtension;
                ...
                string responseName =newName + fileExtension;
